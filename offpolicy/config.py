...
def get_config():
    ...
    # prepare parameters
    parser.add_argument("--algorithm_name", type=str, default="mqmix")
    ...
    parser.add_argument("--save_model", default=True, help="by default True, will use save model; or test the model",)
    parser.add_argument('--num_env_steps', type=int,
                        default=1500, help="Number of env steps to train for")
    ...
    # env parameters
    parser.add_argument('--env_name', type=str, default="two_robots")
